...
from model.retnet.xpos_relative_position import XPOS
...
class SimpleRetention(nn.Module):
    ...
    def forward(self, X):
        ...
        D = self._get_D(sequence_length).to(self.W_Q.device)  # 得到D矩阵
...
# input = torch.randn((8, 16, 512))
# model = SimpleRetention(512, 0.05)
...
# input = torch.randn((8, 16, 512))
# model = MultiScaleRetention(512, 8)
# print(model(input).shape)
